...
H.PredLife<-readRDS("../data/GaussianProcessModeling/H.PredictedAgeData.rds")
count<-H.PredLife %>% 
  group_by(sname,sex) %>% 
  summarise(count=n()) %>% 
  ungroup() %>% 
...
PredLifeCov<-readRDS("../data/GaussianProcessModeling/out/PredictedAge_EnviroCov.rds")
...
slopes2<-readRDS("../data/metadata_slopes_life_and_breakpoints.rds")
ranks<-readRDS("../data/rank_raw_adult_Feb2021.rds") %>% 
